...
export const parseLogLevel = (maybeLevel: string | undefined, sourceName: string, client: VatSense): LogLevel | undefined => {
  if (!maybeLevel) {
    return undefined;
  }
...
export function loggerFor(client: VatSense): Logger {
