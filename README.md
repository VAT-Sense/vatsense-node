...
```sh
npm install git+ssh://git@github.com:VAT-Sense/vatsense-node.git
```
...
We are keen for your feedback; please open an [issue](https://www.github.com/VAT-Sense/vatsense-node/issues) with questions, bugs, or suggestions.
